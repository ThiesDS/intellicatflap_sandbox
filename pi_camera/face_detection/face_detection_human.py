...
detector2 = cv2.CascadeClassifier('/home/doctore/raspberrypi/sandbox/haarcascade_frontalface_default.xml')
...
output = cv2.VideoWriter('output_facedetect_human.avi',fourcc, fps, (frame_width,frame_height))
